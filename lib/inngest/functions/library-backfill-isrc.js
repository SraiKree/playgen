// ⚠️ DEPRECATED / RETIRED — unregistered from app/api/inngest/route.js.
//
// This MusicBrainz-by-Spotify-URL approach does NOT work for our catalog. The
// recording search (query=url:"https://open.spotify.com/track/<id>") matches
// SPAM recordings whose *title* is literally a Spotify URL, returning junk MBIDs
// and ZERO ISRCs (verified against the live data). ISRCs are now backfilled
// directly from Spotify's /me/tracks payload during sync — see
// lib/library.js:backfillTrackIsrcs + migration 0016. Kept for history; do not
// re-register without fixing the matching strategy.
//
// ---------------------------------------------------------------------------
//
